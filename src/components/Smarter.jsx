...
const stages = [
  {
    ...
    color: '#F4175B',
    insights: [
      { label: 'Readiness score', value: '61', unit: '/100', note: 'First measurement' },
      { label: 'HRV baseline', value: '—', unit: '', note: 'Calibrating...' },
      { label: 'Functional age', value: '—', unit: '', note: 'Needs 3 days' },
    ],
    desc: 'First measurement. No baseline yet — Elonga starts learning your unique physiology.',
  },
  {
    day: 'Day 14',
    ...
    color: '#E8105A',
    insights: [
      { label: 'Readiness score', value: '70', unit: '/100', note: 'Your personal norm set' },
      { label: 'HRV baseline', value: '54', unit: 'ms', note: 'Calibrated to you' },
      { label: 'Functional age', value: '43', unit: 'yrs', note: 'vs. 45 actual' },
    ],
    desc: 'Your personal HRV baseline is set. Scores now reflect your biology — not a generic population average.',
  },
  {
    day: 'Day 30',
    title: 'Your patterns emerge',
    color: '#D00F52',
    insights: [
      { label: 'Readiness score', value: '76', unit: '/100', note: '+15 from day 1' },
      { label: 'Stress peak', value: 'Mon–Tue', unit: '', note: 'Week start pattern' },
      { label: 'Biggest drain', value: 'Late calls', unit: '−18%', note: 'HRV impact' },
    ],
    desc: 'Elonga starts connecting dots: late calls tank your sleep, Wednesday meetings land when you\'re lowest. You can now see it.',
  },
  {
    day: 'Day 90',
    ...
    color: '#B80E48',
    insights: [
      { label: 'Readiness score', value: '83', unit: '/100', note: 'Consistent high range' },
      { label: 'Illness warnings', value: '2×', unit: '', note: 'Both caught early' },
      { label: 'Functional age', value: '40', unit: 'yrs', note: '−3 years from start' },
    ],
    desc: 'Elonga knows your rhythms, your stressors, your recovery patterns. Recommendations are built entirely around your life.',
  },
]
